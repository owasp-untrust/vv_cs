...
public abstract class Multiline<TWrapper, TTabPolicy> : BoundedAnyContentStringBase<TWrapper>
    where TWrapper : Multiline<TWrapper, TTabPolicy>, ICreatable<TWrapper, string>
